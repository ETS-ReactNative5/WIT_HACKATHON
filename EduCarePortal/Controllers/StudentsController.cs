...
namespace EduCarePortal.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            ViewBag.ParentID = new SelectList(db.Parents, "ParentID", "FirstName");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "StudentID,FirstName,LastName,DateOfBirth,Email,ParentID")] Student student)
        {
            if (ModelState.IsValid)
            {
